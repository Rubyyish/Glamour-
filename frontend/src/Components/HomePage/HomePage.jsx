...
const HomePage = () => {
  ...
  useEffect(() => {
    // Pause video when AR is open to free up resources
    if (showARTryOn && videoRef.current) {
      videoRef.current.pause();
    } else if (!showARTryOn && videoRef.current) {
      ...
      <section className="ar-section-minimal" id="ar-tryon">
        <div className="ar-content-minimal">
          <div className="ar-text">
            ...
            <button 
              className="btn-primary-minimal launch-ar-btn-minimal"
              onClick={() => setShowARTryOn(true)}
            >
              Launch AR Try-On
            </button>
          ...
          <div className="ar-visual">
            <div className="ar-demo-card">
              ...
              <div className="ar-demo-image">
                ...
                >
                  <source src="/videos/Try-on.webm" type="video/webm" />
