...
import ARGallery from "./Components/ARGallery/ARGallery.jsx";
import ARTryOnPage from "./Components/ARTryOnPage/ARTryOnPage.jsx";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/ar-tryon" element={isAuthenticated ? <ARTryOnPage /> : <Navigate to="/login" />} />
        <Route path="/ar-gallery" element={isAuthenticated ? <ARGallery /> : <Navigate to="/login" />} />
